...
Moeder:
- Stopt wanneer kritieke governance-documenten ontbreken (`workspace-standaard.md`, `gedragscode.md`).
...
- Waarschuwt wanneer nieuwe agents niet aan `agent-standaard.md` voldoen.
