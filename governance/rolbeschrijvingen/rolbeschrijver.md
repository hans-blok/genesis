...
4. **Agent Generatie**
   ...
   - Zorg voor correcte bestandslocaties
   - Lever gebruiksklare agent componenten
...
- ❌ Prompt contracten invullen (alleen skeleton genereren)
- ❌ Runner scripts implementeren (alleen skeleton genereren)
...
4. **Agent Generatie**
   - Genereer agent skeleton: `python scripts/create-agent.py <agent-naam>`
   - Controleer prompt bestand: `.github/prompts/<agent-naam>.prompt.md`
   - Controleer runner bestand: `scripts/<agent-naam>.py`
   - Valideer alle componenten aanwezig
