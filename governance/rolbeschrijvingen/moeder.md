...
4. **Beleid Schrijven**
   ...
   - Workspace doel en context documenteren
   - Scope en niet-in-scope helder definiëren
   - Agents en hun rollen beschrijven
...
5. **Governance Compliance**
   ...
   - Geen aanpassingen aan gedragscode of standaarden
...
1. **Beleid Genereren**
   - Lees temp/context.md voor workspace context
   - Genereer beleid.md met alle verplichte secties
   - Zorg voor duidelijke scope en niet-in-scope
   - Documenteer agents en kwaliteitsnormen
   - Valideer tegen gedragscode Artikel 9
